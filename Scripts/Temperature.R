...
read_and_standardize <- function(file_path) {
  tryCatch({
    ...
    required_columns <- c("event", "date_time", "temperaturec", "field", "pop", "cage", "height", "treatment")
...
date_ranges <- list(
  "2021" = c("2021-06-01", "2021-10-01"),
  "2022" = c("2022-06-01", "2022-10-01"),
  "2023" = c("2023-06-01", "2023-10-01")
)
...
final_output <- calculate_metrics(combined_data)
